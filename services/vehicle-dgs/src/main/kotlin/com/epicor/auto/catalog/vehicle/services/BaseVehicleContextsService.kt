...
interface BaseVehicleContextsService {
    fun baseVehicleContexts(): List<BaseVehicle>
}

@Service
class BasicBaseVehicleContextsService : BaseVehicleContextsService {
    override fun baseVehicleContexts(): List<BaseVehicle> {

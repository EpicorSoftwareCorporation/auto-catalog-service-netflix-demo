...
dependencies {
	api("com.netflix.graphql.dgs:graphql-dgs-spring-boot-starter:3.12.1")
	implementation("com.netflix.graphql.dgs:graphql-dgs-subscriptions-websockets-autoconfigure:3.12.1")
...
tasks.withType<com.netflix.graphql.dgs.codegen.gradle.GenerateJavaTask> {
	generateClient = true
	packageName = "com.epicor.auto.catalog.vehicle.generated"
}
